...
def user_posts(username):
    ...
    return render_template('user_posts.html',posts=posts,title='{{ username }} posts',user=user)
...
If you did not request then simply ignore this email and no changes will be0 made
    '''
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password has been updated! You may able to login', 'success')
        return redirect(url_for('login'))
